...
CYBLE_GAPP_DISC_PARAM_T cyBle_discoveryParam =
{
    ...
    {0x12u, 0x11u, 0x10u, 0x50u, 0xA0u, 0xBBu}, /* uint8* direct_addr */
...
CYBLE_GAP_BD_ADDR_T cyBle_deviceAddress = {{0x12u, 0x11u, 0x10u, 0x50u, 0xA0u, 0xBBu}, 0x00u };
