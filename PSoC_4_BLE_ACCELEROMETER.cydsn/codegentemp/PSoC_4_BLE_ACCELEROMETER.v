// ======================================================================
// PSoC_4_BLE_ACCELEROMETER.v generated from TopDesign.cysch
// 03/12/2017 at 18:28
...
module top ;
	...
	wire [0:0] tmpOE__Accelerometer_X_net;
	wire [0:0] tmpFB_0__Accelerometer_X_net;
	wire [0:0] tmpIO_0__Accelerometer_X_net;
	wire [0:0] tmpINTERRUPT_0__Accelerometer_X_net;
	electrical [0:0] tmpSIOVREF__Accelerometer_X_net;
	...
	cy_psoc3_pins_v1_10
		...
		Accelerometer_X
		 (.oe(tmpOE__Accelerometer_X_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Accelerometer_X_net[0:0]}),
		  .io({tmpIO_0__Accelerometer_X_net[0:0]}),
		  .siovref(tmpSIOVREF__Accelerometer_X_net),
		  .interrupt({tmpINTERRUPT_0__Accelerometer_X_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Accelerometer_X_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Accelerometer_Y_net;
	wire [0:0] tmpFB_0__Accelerometer_Y_net;
	wire [0:0] tmpIO_0__Accelerometer_Y_net;
	wire [0:0] tmpINTERRUPT_0__Accelerometer_Y_net;
	electrical [0:0] tmpSIOVREF__Accelerometer_Y_net;

	cy_psoc3_pins_v1_10
		#(.id("39a08259-2877-4246-8b41-602680950631"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Accelerometer_Y
		 (.oe(tmpOE__Accelerometer_Y_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Accelerometer_Y_net[0:0]}),
		  .io({tmpIO_0__Accelerometer_Y_net[0:0]}),
		  .siovref(tmpSIOVREF__Accelerometer_Y_net),
		  .interrupt({tmpINTERRUPT_0__Accelerometer_Y_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Accelerometer_Y_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Accelerometer_Z_net;
	wire [0:0] tmpFB_0__Accelerometer_Z_net;
	wire [0:0] tmpIO_0__Accelerometer_Z_net;
	wire [0:0] tmpINTERRUPT_0__Accelerometer_Z_net;
	electrical [0:0] tmpSIOVREF__Accelerometer_Z_net;

	cy_psoc3_pins_v1_10
		#(.id("30a4585a-36f3-4ba3-93d8-da1595971452"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Accelerometer_Z
		 (.oe(tmpOE__Accelerometer_Z_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Accelerometer_Z_net[0:0]}),
		  .io({tmpIO_0__Accelerometer_Z_net[0:0]}),
		  .siovref(tmpSIOVREF__Accelerometer_Z_net),
		  .interrupt({tmpINTERRUPT_0__Accelerometer_Z_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Accelerometer_Z_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
