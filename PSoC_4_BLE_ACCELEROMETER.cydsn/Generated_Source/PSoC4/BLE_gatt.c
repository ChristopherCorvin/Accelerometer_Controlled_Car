    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x18u] = {
    /* Device Name */
    (uint8)'B', (uint8)'L', (uint8)'E', (uint8)'_', (uint8)'A', (uint8)'c', (uint8)'c', (uint8)'e', (uint8)'l', 
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* Server_Accel UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* Server_Accel_Tx_data UUID */
    { 0x0001u, (void *)&cyBle_attValues[23] }, /* Server_Accel_Tx_data */
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x0Fu] = {
    ...
    { 0x000Cu, 0x2800u /* Primary service                     */, 0x00080001u /*        */, 0x000Fu, {{0x0010u, (void *)&cyBle_attValuesLen[5]}} },
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00001201u /* rd,ntf */, 0x000Fu, {{0x0010u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x000Eu, 0xCDD1u /* Server_Accel_Tx_data                */, 0x00091201u /* rd,ntf */, 0x000Fu, {{0x0001u, (void *)&cyBle_attValuesLen[7]}} },
