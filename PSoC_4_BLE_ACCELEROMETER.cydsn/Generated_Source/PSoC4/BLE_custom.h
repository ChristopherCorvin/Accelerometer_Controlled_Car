...
#define CYBLE_SERVER_ACCEL_SERVICE_INDEX   (0x00u) /* Index of Server_Accel service in the cyBle_customs array */
#define CYBLE_SERVER_ACCEL_SERVER_ACCEL_TX_DATA_CHAR_INDEX   (0x00u) /* Index of Server_Accel_Tx_data characteristic */
#define CYBLE_SERVER_ACCEL_SERVER_ACCEL_TX_DATA_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */


#define CYBLE_SERVER_ACCEL_SERVICE_HANDLE   (0x000Cu) /* Handle of Server_Accel service */
#define CYBLE_SERVER_ACCEL_SERVER_ACCEL_TX_DATA_DECL_HANDLE   (0x000Du) /* Handle of Server_Accel_Tx_data characteristic declaration */
#define CYBLE_SERVER_ACCEL_SERVER_ACCEL_TX_DATA_CHAR_HANDLE   (0x000Eu) /* Handle of Server_Accel_Tx_data characteristic */
#define CYBLE_SERVER_ACCEL_SERVER_ACCEL_TX_DATA_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Fu) /* Handle of Client Characteristic Configuration descriptor */
