// ======================================================================
// PSoC_4_BLE_CAR.v generated from TopDesign.cysch
// 03/12/2017 at 20:01
...
module BLE_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("84871981-ff65-41c2-a035-3c282ffa2c54/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("9e142b1b-2ed1-435f-8831-2cb724450c20"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8e12c52e-f792-40ea-b650-57bc804984c6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
