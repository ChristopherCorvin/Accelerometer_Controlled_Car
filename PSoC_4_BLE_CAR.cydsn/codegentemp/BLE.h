...
#define CYBLE_GAP_ROLE_BROADCASTER                  (0u != (CYBLE_GAP_ROLE & CYBLE_GAP_BROADCASTER))
    ...
    #define CYBLE_FAST_SCAN_INTERVAL                (0x0004u)
    #define CYBLE_FAST_SCAN_WINDOW                  (0x0004u)
    #define CYBLE_FAST_SCAN_TIMEOUT                 (0x0001u)
...
#define CYBLE_GATT_MAX_ATTR_LEN             ((0x0000u == 0u) ? (1u) : (0x0000u))
